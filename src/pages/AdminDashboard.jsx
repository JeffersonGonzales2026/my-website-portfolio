                ...
                <div className="space-y-4">
                  {analystSkills.map((section, catIdx) => (
                    <div key={catIdx} className="p-4 rounded-xl border border-zinc-900 bg-zinc-950/10 space-y-2 relative pr-8">
                      ...
                      <textarea value={section.skills} onChange={(e) => handleUpdateArrayField(analystSkills, setAnalystSkills, catIdx, 'skills', e.target.value)} className="w-full bg-zinc-950 border border-zinc-900 rounded-lg p-2 text-xs text-zinc-300 font-mono h-16 resize-none" />
                    </div>
                  ))}
                </div>
              </div>
                ...
                {activePortfolioTab === 'reports' && (
                  <div className="space-y-4 pt-2">
                    {portfolioReports.map((item, idx) => (
                      <div key={item.id || idx} className="p-4 rounded-xl border border-zinc-900 bg-zinc-950/30 space-y-2 text-xs relative">
                        <button onClick={() => handleRemoveArrayItem(portfolioReports, setPortfolioReports, idx)} className="absolute top-2 right-2 text-zinc-600 hover:text-red-400"><Trash2 size={14}/></button>
                        <input type="text" value={item.name} onChange={(e) => handleUpdateArrayField(portfolioReports, setPortfolioReports, idx, 'name', e.target.value)} className="bg-zinc-950 border border-zinc-900 p-1.5 rounded text-white" placeholder="Report Name" />
                        <input type="text" value={item.purpose} onChange={(e) => handleUpdateArrayField(portfolioReports, setPortfolioReports, idx, 'purpose', e.target.value)} className="w-full bg-zinc-950 border border-zinc-900 p-1.5 rounded text-zinc-300" placeholder="Purpose Statement" />
                      </div>
                    ))}
                  </div>
                )}
                {activePortfolioTab === 'automations' && (
                  <div className="space-y-4 pt-2">
                    {portfolioAutomations.map((item, idx) => (
                      <div key={item.id || idx} className="p-4 rounded-xl border border-zinc-900 bg-zinc-950/30 space-y-2 text-xs relative">
                        <button onClick={() => handleRemoveArrayItem(portfolioAutomations, setPortfolioAutomations, idx)} className="absolute top-2 right-2 text-zinc-600 hover:text-red-400"><Trash2 size={14}/></button>
                        <input type="text" value={item.name} onChange={(e) => handleUpdateArrayField(portfolioAutomations, setPortfolioAutomations, idx, 'name', e.target.value)} className="bg-zinc-950 border border-zinc-900 p-1.5 rounded text-white" placeholder="Automation Name" />
                        <input type="text" value={item.purpose} onChange={(e) => handleUpdateArrayField(portfolioAutomations, setPortfolioAutomations, idx, 'purpose', e.target.value)} className="w-full bg-zinc-950 border border-zinc-900 p-1.5 rounded text-zinc-300" placeholder="Purpose Statement" />
                      </div>
                    ))}
                  </div>
                )}
                {activePortfolioTab === 'caseStudies' && (
                  <div className="space-y-4 pt-2">
                    {portfolioCaseStudies.map((item, idx) => (
                      <div key={item.id || idx} className="p-4 rounded-xl border border-zinc-900 bg-zinc-950/30 space-y-2 text-xs relative">
                        <button onClick={() => handleRemoveArrayItem(portfolioCaseStudies, setPortfolioCaseStudies, idx)} className="absolute top-2 right-2 text-zinc-600 hover:text-red-400"><Trash2 size={14}/></button>
                        <input type="text" value={item.name} onChange={(e) => handleUpdateArrayField(portfolioCaseStudies, setPortfolioCaseStudies, idx, 'name', e.target.value)} className="bg-zinc-950 border border-zinc-900 p-1.5 rounded text-white" placeholder="Case Study Name" />
                        <input type="text" value={item.purpose} onChange={(e) => handleUpdateArrayField(portfolioCaseStudies, setPortfolioCaseStudies, idx, 'purpose', e.target.value)} className="w-full bg-zinc-950 border border-zinc-900 p-1.5 rounded text-zinc-300" placeholder="Purpose Statement" />
                      </div>
                    ))}
                  </div>
                )}
                {activePortfolioTab === 'projects' && (
                  <div className="space-y-4 pt-2">
                    {portfolioProjects.map((item, idx) => (
                      <div key={item.id || idx} className="p-4 rounded-xl border border-zinc-900 bg-zinc-950/30 space-y-2 text-xs relative">
                        <button onClick={() => handleRemoveArrayItem(portfolioProjects, setPortfolioProjects, idx)} className="absolute top-2 right-2 text-zinc-600 hover:text-red-400"><Trash2 size={14}/></button>
                        ...
                        <input type="text" value={item.purpose} onChange={(e) => handleUpdateArrayField(portfolioProjects, setPortfolioProjects, idx, 'purpose', e.target.value)} className="w-full bg-zinc-950 border border-zinc-900 p-1.5 rounded text-zinc-300" placeholder="Purpose Statement" />
                      </div>
                    ))}
                  </div>
                )}
