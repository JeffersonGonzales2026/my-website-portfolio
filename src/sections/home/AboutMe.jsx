...
export default function AboutMe() {
  return (
    <section className="max-w-7xl mx-auto px-6 py-24 relative overflow-hidden">
      ...
      {/* 
        Workspace Image Blended into Background 
        (Tinanggal ang box, ginawang seamless background sa kaliwa) 
      */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        {/* Left Aspect: Text nakapatong mismo sa Image Background */}
        <div className="lg:col-span-5 space-y-6 py-10 lg:py-20">
          <motion.div 
            ...
            className="space-y-5"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.03] border border-white/10 text-slate-400 text-[11px] font-mono tracking-widest uppercase backdrop-blur-sm">
              <Sparkles size={14} className="text-slate-500" />
              My Narrative
            </div>
            
            {/* Chromatic Aberration Text Effect (Gaya ng nasa code mo) */}
